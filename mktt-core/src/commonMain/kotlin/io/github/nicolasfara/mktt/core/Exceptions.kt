 ...
 */
public class MalformedPacketException(message: String? = null) : io.github.nicolasfara.mktt.core.MqttException(message)
...
public class ConnectionException(message: String? = null, cause: Throwable? = null) :
    io.github.nicolasfara.mktt.core.MqttException(message = message, cause = cause)

/**
 * Indicates that a packet was not received within the expected time.
 */
public class TimeoutException(message: String) : io.github.nicolasfara.mktt.core.MqttException(message)

/**
 * Indicates that the topic alias value of a publish request exceed the "Topic Alias Maximum" sent by the server.
 */
public class TopicAliasException(message: String?) : io.github.nicolasfara.mktt.core.MqttException(message)
...
) : io.github.nicolasfara.mktt.core.MqttException(message)
